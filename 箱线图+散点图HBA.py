...
# 创建箱线图+散点图组合
ax = sns.boxplot(data=df, x='HBA', y='pIC50', color='lightgray', width=0.6, fliersize=0)
sns.stripplot(data=df, x='HBA', y='pIC50', hue='target_class', 
             palette=custom_palette, size=6, alpha=0.8, jitter=True, dodge=True,
             edgecolor='black', linewidth=0.5)

plt.title('pIC50 vs Hydrogen Bond Acceptors (HBA)', fontsize=20, fontweight='bold', pad=20)
plt.xlabel('Hydrogen Bond Acceptors (HBA)', fontsize=16, fontweight='bold')
